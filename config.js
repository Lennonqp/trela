...
// ============================================================
// JÁ TEM O PROJETO CRIADO? (seu caso)
// ============================================================
// Se a tabela "recados" já existe no seu Supabase, não precisa
// recriar nada. Só rode isto uma vez no SQL Editor pra adicionar
// as 3 colunas novas (número do adesivo, nome e instagram):
//
//    alter table recados add column if not exists numero text;
//    alter table recados add column if not exists nome text;
//    alter table recados add column if not exists instagram text;
// ============================================================
